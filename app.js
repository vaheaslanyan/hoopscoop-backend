...
app.use((req, res, next) => {
  res.setHeader("Access-Control-Allow-Origin", "*"); //sets header to responses in order to avoid the browser CORS security error, the second argument indicates which urls should be allowed (star meaning any url)
  res.setHeader(
